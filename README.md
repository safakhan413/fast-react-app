...
To test the endpoints, navigate to the root directory and run the following command:
...
![Download CSV Page](https://github.com/safakhan413/fast-react-app/blob/main/download.png "Download CSV Page")
